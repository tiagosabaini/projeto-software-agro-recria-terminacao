...
def cadastro():
    if request.method == 'POST':
        ...
        conexao = conectar()
        conexao.execute('''
            INSERT INTO lotes (identificacao, fase_atual, data_inicio, qtd_cabecas, custo_bezerro_unitario, custo_total_compra)
            VALUES (?, ?, ?, ?, ?, ?)
        ''', (identificacao, fase_atual, data_inicio, qtd_cabecas, custo_bezerro_unitario, custo_total_compra))
        conexao.commit()
        conexao.close()
...
def painel():
    ...
    if lote_id:
        ...
        if lote_selecionado:
            ...
            sobra_liquida = lote_selecionado['valor_venda_total'] - custo_total_operacao
            ...
            balanco_final = {
                ...
                'receita_venda': lote_selecionado['valor_venda_total'],
